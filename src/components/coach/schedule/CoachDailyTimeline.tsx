          ...
          if (item.kind === 'lesson') {
            return (
              <LessonCard
                ...
                onCancel={() => setLessonDetails(item.request)}
    ...
    <TimelineShell code="L" color="#0F1F3D">
      <TouchableOpacity style={styles.card} onPress={onDetails} activeOpacity={0.82}>
        ...
        <View style={styles.actions}>
          ...
          <Action label="Cancel" destructive onPress={onCancel} />
        </View>
      </TouchableOpacity>
    </TimelineShell>
  );
    ...
    <DetailsSheet visible title="Lesson Details" onClose={onClose}>
      <View style={styles.studentRow}>
        ...
        <View style={styles.studentCopy}>
          ...
          <Text style={styles.meta}>{LESSON_LABELS[request.lessonType] ?? request.lessonType}</Text>
        </View>
      </View>
      ...
      <DetailRow label="STATUS" value={request.status.replaceAll('_', ' ')} />
      <DetailRow label="LOCATION TYPE" value={request.locationPreference} />
      ...
      <Action label="Mark Complete" icon={<Check size={16} color={theme.textSecondary} />} onPress={onMarkComplete} />
      <TextInput
        value={reason}
