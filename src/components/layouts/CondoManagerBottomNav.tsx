          ...
          return (
            ...
            >
              <div className="relative">
                <Icon className={`h-5 w-5 transition-colors ${active ? 'text-emerald-700' : 'text-muted-foreground'}`} />
              ...
              <span className={`text-[10px] font-bold transition-colors ${active ? 'text-emerald-700' : 'text-muted-foreground'}`}>
                {item.label}
              </span>
