...
import { Bell, Mail, MessageSquare, Trophy, BookOpen, Users, Megaphone } from 'lucide-react';
...
const NotificationsSection: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="flex items-center justify-between py-4 px-4 rounded-xl hover:bg-muted/30 transition-colors">
                ...
                <Switch
                  checked={preferences.match_requests}
              ...
              <div className="flex items-center justify-between py-4 px-4 rounded-xl hover:bg-muted/30 transition-colors">
                ...
                <Switch
                  checked={preferences.lesson_updates}
      ...
      {/* Email Notifications - Using the existing EmailPreferences component */}
