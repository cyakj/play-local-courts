      ...
      <div className="px-4 pt-4 pb-24 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB]">
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-[14px] text-[#1A1A2E]">Two-Factor Authentication</p>
          ...
          <div className="mt-3 ml-11">
            <span className="text-[11px] font-semibold text-[#9CA3AF] bg-[#F0F4F8] px-2.5 py-1 rounded-full">Not enabled</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB]">
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="font-bold text-[14px] text-[#1A1A2E]">Active Sessions</p>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between py-2 px-3 rounded-xl bg-[#F0F4F8]">
              <div>
                <p className="text-[13px] font-semibold text-[#1A1A2E]">Current Device</p>
                <p className="text-[11px] text-[#9CA3AF]">Web Browser • Active now</p>
              </div>
              <span className="text-[10px] font-bold text-[#00B4D8] bg-[#00B4D8]/10 px-2 py-0.5 rounded-full">This device</span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB]">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-[13px] font-semibold text-[#1A1A2E]">Last Password Change</p>
